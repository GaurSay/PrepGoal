...
public class BuyNSellStock5 {

    public static void main(String[] args) {
        long[] prices = {7, 1, 5, 3, 6, 4};
        // buy and sell stock 5 says that you cannot buy after sell immediately as there is cool off period.
        // so you just to i+2 day to buy and not i+1,
        // this just needs to make dp array with n+2 size in tabulation.
    ...
    private static long findMaxProfit(int index, int buy, int n, long[] prices) {
        ...
        if(buy==0){
            ...
            profit = Math.max((prices[index] + findMaxProfit(index+2,0,n,prices)),
