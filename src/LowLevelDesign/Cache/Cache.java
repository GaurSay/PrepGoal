...
import LowLevelDesign.Cache.Exceptions.NotFoundException;
import LowLevelDesign.Cache.Exceptions.StorageFullException;
import LowLevelDesign.Cache.policies.EvictionPolicy;
import LowLevelDesign.Cache.storage.Storage;
...
public class Cache<Key,Value> {
    ...
    public void put(Key key, Value value) throws NotFoundException, NoSuchElementException {
        try {
